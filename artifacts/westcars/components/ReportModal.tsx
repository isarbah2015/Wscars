...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 17, fontFamily: "Manrope_700Bold", color: "#1A1A1A", flex: 1 },
  subtitle: { fontSize: 13, fontFamily: "Manrope_600SemiBold", color: "#6B6B6B", marginBottom: 4, marginTop: 4 },
  option: {
  ...
  optionText: { fontSize: 14, fontFamily: "Manrope_400Regular", color: "#1A1A1A", flex: 1 },
  optionTextSelected: { fontFamily: "Manrope_600SemiBold", color: "#0066CC" },
  details: {
    borderWidth: 1.5, borderColor: "#E8E8E8", borderRadius: 12,
    padding: 12, fontSize: 14, fontFamily: "Manrope_400Regular",
  ...
  cancelText: { fontSize: 15, fontFamily: "Manrope_600SemiBold", color: "#6B6B6B" },
  submitBtn: {
    flex: 2, height: 50, borderRadius: 12,
    backgroundColor: "#E53935", alignItems: "center", justifyContent: "center",
  },
  submitText: { fontSize: 15, fontFamily: "Manrope_700Bold", color: "#fff" },
});
