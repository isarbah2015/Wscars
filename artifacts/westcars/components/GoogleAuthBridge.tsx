 ...
 *
 * Uses expo-auth-session Google provider for OAuth.
 * Requires EXPO_PUBLIC_GOOGLE_IOS_CLIENT_ID / EXPO_PUBLIC_GOOGLE_ANDROID_CLIENT_ID
 * to be set; if they are missing the parent (login.tsx) will not render this
 * component at all, so no request is ever made.
 */
