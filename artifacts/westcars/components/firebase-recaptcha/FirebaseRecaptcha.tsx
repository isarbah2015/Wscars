...
<body>
  ${invisible ? `<button id="recaptcha-btn" type="button" onclick="onClickButton()">Confirm reCAPTCHA</button>` : `<div id="recaptcha-cont"></div>`}
  <script>
...
export default function FirebaseRecaptcha(props: Props) {
  ...
  if (!firebaseConfig.authDomain) {
    console.error("[FirebaseRecaptcha] Missing authDomain in firebase config.");
    return null;
  }
