...
const styles = StyleSheet.create({
  ...
  openBtnText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#0EB5CA" },
  nativeMapCard: {
  ...
  pinHead: {},
  pinLabel: { fontSize: 12, fontFamily: "Inter_700Bold" },
  openOverlay: {
    position: "absolute", bottom: 10, right: 10,
    flexDirection: "row", alignItems: "center", gap: 5,
    backgroundColor: "rgba(255,255,255,0.85)", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5,
  },
  openOverlayText: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: "#0EB5CA" },
});
