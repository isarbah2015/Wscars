...
const styles = StyleSheet.create({
  ...
  blockedCount: { fontSize: 12, fontFamily: "Inter_500Medium", padding: 14, paddingBottom: 0 },
  ...
  blockedId: { flex: 1, fontSize: 13, fontFamily: "Inter_500Medium" },
  unblockBtn: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, backgroundColor: "rgba(14,181,202,0.12)" },
  unblockText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#0EB5CA" },
  ...
  privTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  privSub: { fontSize: 11, fontFamily: "Inter_400Regular" },
