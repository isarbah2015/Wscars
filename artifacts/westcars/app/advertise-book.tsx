...
const styles = StyleSheet.create({
  ...
  autoGenTitle: { fontSize: 18, fontFamily: "Manrope_800ExtraBold", color: "#1A1A1A", letterSpacing: -0.2 },
  autoGenSub: {
  ...
  sumTotalVal: { fontSize: 20, fontFamily: "Manrope_800ExtraBold", color: "#0066CC", letterSpacing: -0.3 },
  ...
  submitPrice: { fontSize: 22, fontFamily: "Manrope_800ExtraBold", color: "#0066CC", letterSpacing: -0.4 },
  submitBtn: {
