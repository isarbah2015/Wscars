...
const styles = StyleSheet.create({
  ...
  contactValue: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#0EB5CA", marginTop: 1 },
  ...
  formLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", marginBottom: 4 },
  contactHint: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 2 },
  input: {
