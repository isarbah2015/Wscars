...
const styles = StyleSheet.create({
  ...
  itemText: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 20, flex: 1 },
  contactCard: {
    flexDirection: "row", alignItems: "flex-start", gap: 12,
    borderRadius: 16, borderWidth: 1, padding: 16,
  },
  contactTitle: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  contactEmail: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#0EB5CA", textDecorationLine: "underline" },
  footer: { fontSize: 12, fontFamily: "Inter_400Regular", textAlign: "center", lineHeight: 18, marginTop: 4 },
});
