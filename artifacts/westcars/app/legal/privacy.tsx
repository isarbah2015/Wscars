...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 15, fontFamily: "PlusJakartaSans_700Bold", flex: 1 },
  itemList: { gap: 8 },
  itemRow: { flexDirection: "row", alignItems: "flex-start", gap: 10 },
  dot: { width: 5, height: 5, borderRadius: 3, marginTop: 7 },
  itemText: { fontSize: 13, fontFamily: "PlusJakartaSans_400Regular", lineHeight: 20, flex: 1 },
  contactCard: {
  ...
  footer: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", textAlign: "center", lineHeight: 18, marginTop: 4 },
});
