...
const styles = StyleSheet.create({
  ...
  cardBody: { fontSize: 13, fontFamily: "Manrope_400Regular", lineHeight: 20 },

  missionCard: { borderRadius: 16, borderWidth: 1.5, overflow: "hidden" },
  missionGrad: { padding: 20, alignItems: "center", gap: 8 },
  missionTitle: { fontSize: 16, fontFamily: "Manrope_700Bold" },
  missionBody: { fontSize: 13, fontFamily: "Manrope_400Regular", textAlign: "center", lineHeight: 20 },
  ...
  featureLabel: { fontSize: 13, fontFamily: "Manrope_700Bold" },
  featureDesc: { fontSize: 11, fontFamily: "Manrope_400Regular", lineHeight: 16 },

  emailLink: { fontSize: 13, fontFamily: "Manrope_600SemiBold", color: "#0EB5CA", textDecorationLine: "underline" },
  ...
  socialLabel: { fontSize: 11, fontFamily: "Manrope_600SemiBold" },
  ...
  rateText: { fontSize: 15, fontFamily: "Manrope_700Bold", color: "#fff" },

  credits: { fontSize: 12, fontFamily: "Manrope_400Regular", textAlign: "center", lineHeight: 20 },
});
