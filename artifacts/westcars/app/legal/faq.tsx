...
const FAQS = [
  ...
  { q: "How do I verify my identity?", a: "Go to Profile → Settings → Verification Centre. Tap 'ID Verification', upload a clear photo of your Ghana Card or Passport, then take a selfie. Our partner Smile ID will verify your identity typically within minutes. Verified users receive a blue badge on their profile and listings." },
