...
const styles = StyleSheet.create({
  ...
  count: { fontSize: 12, fontFamily: "PlusJakartaSans_500Medium", marginBottom: 2 },
  item: {
  ...
  question: { flex: 1, fontSize: 14, fontFamily: "PlusJakartaSans_600SemiBold", lineHeight: 20 },
  answerWrap: { paddingHorizontal: 16, paddingBottom: 16, paddingTop: 12, borderTopWidth: 1 },
  answer: { fontSize: 13, fontFamily: "PlusJakartaSans_400Regular", lineHeight: 21 },
  contactCard: {
    flexDirection: "row", alignItems: "flex-start", gap: 12,
    borderRadius: 16, borderWidth: 1, padding: 16, marginTop: 4,
  },
  contactTitle: { fontSize: 14, fontFamily: "PlusJakartaSans_700Bold" },
  contactSub: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular" },
