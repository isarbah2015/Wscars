...
const styles = StyleSheet.create({
  ...
  numText: { fontSize: 12, fontFamily: "Manrope_700Bold", color: "#fff" },
  sectionTitle: { fontSize: 15, fontFamily: "Manrope_700Bold", flex: 1 },
  sectionBody: { fontSize: 13, fontFamily: "Manrope_400Regular", lineHeight: 21 },
  contactCard: {
  ...
  acceptText: { fontSize: 16, fontFamily: "Manrope_700Bold", color: "#fff" },
});
