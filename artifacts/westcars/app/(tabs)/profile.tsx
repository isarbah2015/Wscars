...
const styles = StyleSheet.create({
  ...
  userLocation: { fontSize: 13, fontFamily: "Inter_400Regular" },
  veriBadges: { marginTop: 2 },
  verifyBtn: {
    flexDirection: "row", alignItems: "center", gap: 6,
    backgroundColor: "#0EB5CA", paddingHorizontal: 16, paddingVertical: 7, borderRadius: 20,
  },
  verifyBtnText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#FFFFFF" },
  ...
  statValue: { fontSize: 18, fontFamily: "Manrope_800ExtraBold", letterSpacing: -0.2 },
  ...
  adBoostSub: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 2 },
  ...
  soldOverlayText: { fontSize: 18, fontFamily: "Inter_600SemiBold", color: "#fff", letterSpacing: 2 },
  expiry: {
  ...
  expiryText: { fontSize: 9, fontFamily: "Inter_500Medium", color: "#FBBF24" },
  ...
  settingHint: { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 1 },
  ...
  veriTitle: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
  veriSub: { fontSize: 11, fontFamily: "Inter_400Regular" },
  veriBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  veriBadgeText: { fontSize: 12, fontFamily: "Inter_600SemiBold" },
