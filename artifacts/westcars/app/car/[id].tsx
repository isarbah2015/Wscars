...
const styles = StyleSheet.create({
  ...
  carTitle: { fontSize: 22, fontFamily: "Manrope_800ExtraBold", color: "#1A1A1A", letterSpacing: -0.4 },
  ratingLine: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  specCardValue: { fontSize: 16, fontFamily: "Inter_700Bold", textAlign: "center" },
  specCardLabel: { fontSize: 9, fontFamily: "Inter_600SemiBold", letterSpacing: 1.2, textAlign: "center" },
  ...
  mileageBarLabel: { flex: 1, fontSize: 12, fontFamily: "Inter_500Medium" },
  mileageBarValue: { fontSize: 13, fontFamily: "Inter_700Bold" },
  ...
  mileageScaleText: { fontSize: 9, fontFamily: "Inter_400Regular" },
  ...
  fullSpecsBtnText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff", letterSpacing: 0.2 },
  ...
  keySpecValue: { fontSize: 13, fontFamily: "Inter_700Bold" },
  keySpecLabel: { fontSize: 10, fontFamily: "Inter_400Regular", marginTop: 1 },
  ...
  equipAccordionLabel: { fontSize: 14, fontFamily: "Inter_700Bold" },
  equipAccordionCount: { fontSize: 11, fontFamily: "Inter_500Medium", marginTop: 2 },
  equipAccordionBadge: {
    minWidth: 28, paddingHorizontal: 9, paddingVertical: 4,
    borderRadius: 10, alignItems: "center",
  },
  equipAccordionBadgeText: { fontSize: 12, fontFamily: "Inter_700Bold" },
  equipItemsList: {
    paddingHorizontal: 16,
    paddingVertical: 6,
    borderTopWidth: 1,
  ...
  soldBannerText: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#fff" },
